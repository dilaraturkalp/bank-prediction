...
def main():
    ...
    if st.button('Tahmin Et'):
        ...
        # Tahmini yorumla
        if prediction == 1:
            diagnosis = f"Müşteri vadeli mevduat hesabına abone olacak. (Olasılık: {probability:.2f})"
        else:
            diagnosis = f"Müşteri vadeli mevduat hesabına abone olmayacak. (Olasılık: {probability:.2f})"
